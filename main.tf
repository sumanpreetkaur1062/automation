module "resource_group" {
  source    = "./modules/rgroup-n01678844"
...
module "network" {
  source              = "./modules/network-n01678844"
  humber_id           = var.humber_id
  location            = var.location
...
module "common_services" {
  source              = "./modules/common_services-n01678844"
  humber_id           = var.humber_id
  location            = var.location
  resource_group_name = module.resource_group.rg_name
  tags                = var.tags
...
module "linux_vms" {
  source                     = "./modules/vmlinux-n01678844"
  humber_id                  = var.humber_id
  location                   = var.location
  resource_group_name        = module.resource_group.rg_name
...
module "windows_vms" {
  source                     = "./modules/vmwindows-n01678844"
  humber_id                  = var.humber_id
  location                   = var.location
  resource_group_name        = module.resource_group.rg_name
  subnet_id                  = module.network.subnet_id
...
module "data_disks" {
  source              = "./modules/datadisk-n01678844"
  humber_id           = var.humber_id
  location            = var.location
  resource_group_name = module.resource_group.rg_name
...
module "load_balancer" {
  source              = "./modules/loadbalancer-n01678844"
  humber_id           = var.humber_id
  location            = var.location
  resource_group_name = module.resource_group.rg_name
  tags                = var.tags
...
module "database" {
  source                  = "./modules/database-n01678844"
  humber_id               = var.humber_id
  location                = var.location
  resource_group_name     = module.resource_group.rg_name
  admin_username          = var.admin_username
